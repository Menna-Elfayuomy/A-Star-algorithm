...
The standard version selection criteria simply works as >if that node is signed/flagged as free and it hasn't been visited before the algorithm can consider it then go to calculate its cost and proceed further <br/> <br/>
